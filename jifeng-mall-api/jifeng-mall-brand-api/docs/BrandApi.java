...
public class BrandApi {
    ...
    @SentinelResource(value = "brand-api:find-by-id",
            blockHandler = "block4FindById", fallback = "degrade4FindById")
    @GetMapping("/id/{id}")
    ...
    public JsonResp block4FindById(@PathVariable Long id, BlockException e) {
        return JsonResp.fail(429, "brand-api:find-by-id请求过快");
    }

    public JsonResp degrade4FindById(@PathVariable Long id, Throwable t) {
        return JsonResp.fail(503, "brand-api:find-by-id服务不可用");
    }
